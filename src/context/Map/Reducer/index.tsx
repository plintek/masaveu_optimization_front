...
export const MapReducer = (initialState: MapState, action: ActionObject): MapState => {
    switch (action.type) {
        ...
        case "CHANGE_VIEW_STATE":
            return {
                ...initialState,
                viewState: { ...initialState.viewState, ...action.payload?.viewState },
            };

        case "CHANGE_ZOOM":
            const zoom = initialState.viewState.zoom ? initialState.viewState.zoom : 12.5;
            return {
                ...initialState,
